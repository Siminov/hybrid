...
public class HybridSiminovDataBuilder {
	...
	public static String jsonBuidler(HybridSiminovDatas jsSiminovDatas) throws SiminovException {
		...
		if(jsonHybridSiminovDatas.length() > 0) {
			try {
				...
				Log.loge(HybridSiminovDataBuilder.class.getName(), "jsonBuidler", "Exception caught while adding json js core datas, " + exception.getMessage());
				throw new SiminovException(HybridSiminovDataBuilder.class.getName(), "jsonBuidler", "Exception caught while adding json js core datas, " + exception.getMessage());
			}
		}
		...
		try {
			...
			Log.loge(HybridSiminovDataBuilder.class.getName(), "jsonBuidler", "Exception caught while adding final js core data, " + exception.getMessage());
			throw new SiminovException(HybridSiminovDataBuilder.class.getName(), "jsonBuidler", "Exception caught while adding final js core data, " + exception.getMessage());
		}
	...
	private static JSONObject jsonBuilder(HybridSiminovData hybridSiminovData) throws SiminovException {
		...
		try {
			...
			Log.loge(HybridSiminovDataBuilder.class.getName(), "jsonBuilder", "Exception caught while adding data type to json js core data, DATA-TYPE: " + dataType + ", " + exception.getMessage());
			throw new SiminovException(HybridSiminovDataBuilder.class.getName(), "jsonBuilder", "Exception caught while adding data type to json js core data, DATA-TYPE: " + dataType + ", " + exception.getMessage());
		}

		try {
			jsonHybridSiminovData.put(Constants.HYBRID_SIMINOV_DATA_JSON_TEXT, dataValue);
		} catch(Exception exception) {
			Log.loge(HybridSiminovDataBuilder.class.getName(), "jsonBuilder", "Exception caught while adding data to json js core data, DATA: " + dataValue + ", " + exception.getMessage());
			throw new SiminovException(HybridSiminovDataBuilder.class.getName(), "jsonBuilder", "Exception caught while adding data to json js core data, DATA: " + dataValue + ", " + exception.getMessage());
		}
		...
		while(hybridSiminovValues.hasNext()) {
			...
			try {
				...
				Log.loge(HybridSiminovDataBuilder.class.getName(), "jsonBuilder", "Exception caught while adding value type, VALUE-TYPE: " + valueType + ", " + exception.getMessage());
				throw new SiminovException(HybridSiminovDataBuilder.class.getName(), "jsonBuilder", "Exception caught while adding value type, VALUE-TYPE: " + valueType + ", " + exception.getMessage());
			}
			
			try {
				jsonHybridSiminovValue.put(Constants.HYBRID_SIMINOV_DATA_JSON_TEXT, value);
			} catch(Exception exception) {
				Log.loge(HybridSiminovDataBuilder.class.getName(), "jsonBuilder", "Exception caught while adding value, VALUE: " + value + ", " + exception.getMessage());
				throw new SiminovException(HybridSiminovDataBuilder.class.getName(), "jsonBuilder", "Exception caught while adding value, VALUE: " + value + ", " + exception.getMessage());
			}
		...
		if(jsonHybridSiminovValues.length() >  0) {
			try {
				...
				Log.loge(HybridSiminovDataBuilder.class.getName(), "jsonBuilder", "Exception caught while adding value to json js core data, " + exception.getMessage());
				throw new SiminovException(HybridSiminovDataBuilder.class.getName(), "jsonBuilder", "Exception caught while adding value to json js core data, " + exception.getMessage());
			}
		}
		...
		if(jsonHybridSiminovSubDatas.length() > 0) {
			try {
				...
				Log.loge(HybridSiminovDataBuilder.class.getName(), "jsonBuilder", "Exception caught while adding data to js core data, " + exception.getMessage());
				throw new SiminovException(HybridSiminovDataBuilder.class.getName(), "jsonBuilder", "Exception caught while adding data to js core data, " + exception.getMessage());
			}
		}
