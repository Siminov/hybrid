 ...
 *
 */
public class HybridLibraryDescriptorReader extends SiminovSAXDefaultHandler implements Constants {
	...
	public HybridLibraryDescriptorReader(final String libraryName) throws SiminovException {
