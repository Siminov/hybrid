...
public class HybridSiminovDataParser implements Constants {
	...
	public HybridSiminovDataParser(String data) throws SiminovException {
		...
		try {
			if(datas != null && datas.length() > 0) {
				for(int i = 0;i < datas.length();i++) {
					...
					try {
						...
						Log.loge(HybridSiminovDataParser.class.getName(), "parseData", "Exception caught while geeting json object from datas, " + exception.getMessage());
						throw new SiminovException(HybridSiminovDataParser.class.getName(), "parseData", "Exception caught while geeting json object from datas, " + exception.getMessage());
					}
			...
			Log.loge(HybridSiminovDataParser.class.getName(), "Constructor", "Exception caught while parsing data tag, " + siminovException.getMessage());
	...
	private HybridSiminovData parseData(JSONObject data) throws SiminovException {
		...
		while(keys.hasNext()) {
			...
			if(key.equalsIgnoreCase(HYBRID_SIMINOV_DATA_JSON_TYPE)) {
				...
				try {
					...
					Log.loge(HybridSiminovDataParser.class.getName(), "parseData", "Exception caught while getting values array, " + exception.getMessage());
					throw new SiminovException(HybridSiminovDataParser.class.getName(), "parseData", "Exception caught while getting values array, " + exception.getMessage());
				}
				...
				try {
					...
					Log.loge(HybridSiminovDataParser.class.getName(), "parseData", "Exception caught while getting datas array, " + exception.getMessage());
					throw new SiminovException(HybridSiminovDataParser.class.getName(), "parseData", "Exception caught while getting datas array, " + exception.getMessage());
				}
			}
		}
		...
		try {
			...
			Log.loge(HybridSiminovDataParser.class.getName(), "parseData", "Exception caught while parsing data tag, " + siminovException.getMessage());
			throw siminovException;
		}
	...
	private void parseDataValue(HybridSiminovData hybridSiminovData, JSONArray values) throws SiminovException {
		...
		for(int i = 0;i < values.length();i++) {
			...
			try {
				...
				Log.loge(HybridSiminovDataParser.class.getName(), "parseData", "Exception caught while geeting json object from values, " + exception.getMessage());
				throw new SiminovException(HybridSiminovDataParser.class.getName(), "parseData", "Exception caught while geeting json object from values, " + exception.getMessage());
			}
	...
	private Object getValue(String name, JSONObject jsonObject) throws SiminovException {
		...
		try {
			...
			Log.loge(HybridSiminovDataParser.class.getName(), "", "Exception caught while getting value, " + exception.getMessage());
			throw new SiminovException(HybridSiminovDataParser.class.getName(), "", "Exception caught while getting value, " + exception.getMessage());
		}
	}
	...
	private JSONObject getJSONObject(String name, JSONObject jsonObject) throws SiminovException {
		...
		try {
			...
			Log.loge(HybridSiminovDataParser.class.getName(), "", "Exception caught while getting json object, " + exception.getMessage());
			throw new SiminovException(HybridSiminovDataParser.class.getName(), "", "Exception caught while getting json object, " + exception.getMessage());
		}
	}
	...
	private JSONArray getJSONArray(String name, JSONObject jsonObject) throws SiminovException {
		...
		try {
			...
			Log.loge(HybridSiminovDataParser.class.getName(), "", "Exception caught while getting json array, " + exception.getMessage());
			throw new SiminovException(HybridSiminovDataParser.class.getName(), "", "Exception caught while getting json array, " + exception.getMessage());
		}
	}
