...
public class Adapter {
	...
	public void invoke() {
		...
		if(handlerName == null && handlerName.length() <= 0) {
			handler.handleNativeToHybrid(adapterName, parameters.toArray(new String[parameters.size()]));
		} else {
			handler.handleNativeToHybrid(adapterName + "." + handlerName, parameters.toArray(new String[parameters.size()]));
		}
	}
