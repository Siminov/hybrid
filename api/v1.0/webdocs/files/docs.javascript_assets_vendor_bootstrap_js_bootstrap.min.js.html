...
<head>
    <meta charset="utf-8">
    <title>docs.javascript\assets\vendor\bootstrap\js\bootstrap.min.js - Siminov Web</title>
    <link rel="stylesheet" href="">
    <link rel="stylesheet" href="../assets/vendor/prettify/prettify-min.css">
    <link rel="stylesheet" href="../assets/css/main.css" id="site_styles">
    <link rel="stylesheet" href="../assets/css/custom.css">
    <link rel="stylesheet" href="../assets/vendor/bootstrap/css/bootstrap.css">
    <link rel="shortcut icon" href="../yuidoc.assets/product_logo.ico">   
</head>
<body class="yui3-skin-sam">
<div class="navbar navbar-fixed-top">
    <div class="navbar-inner">
        <h1 class="brand" style="padding: 10px 16px 10px; height: 20px; line-height: 20px; margin-left: 0;">
	    <img alt="Siminov Web" src="..\yuidoc.assets\siminov-logo.gif" style="max-height: 65%;" title="Siminov Web">
            Siminov Web
        </h1>
	<div class="nav">
        ...
        <form class="navbar-form pull-right" style="line-height: 40px; height: 40px;">
            <input style="margin-top: 0;" type="text" class="search-query" placeholder="Search for classes/modules..." data-obj='["classes/Adapter", "classes/AdapterDescriptor.Handler", "classes/AdapterDescriptor.Handler.Parameter", "classes/ApplicationDescriptor", "classes/Clause", "classes/ConnectionRequest", "classes/ConnectionResponse", "classes/Constants", "classes/Database", "classes/DatabaseDescriptor", "classes/DatabaseException", "classes/DatabaseMappingDescriptor", "classes/DatabaseMappingDescriptor.Attribute", "classes/DatabaseMappingDescriptor.Index", "classes/DatabaseMappingDescriptor.Relationship", "classes/DeploymentException", "classes/Dictionary", "classes/EventHandler", "classes/Function", "classes/IAverage", "classes/IAverageClause", "classes/ICount", "classes/ICountClause", "classes/IDelete", "classes/IDeleteClause", "classes/IGroupConcat", "classes/IGroupConcatClause", "classes/IMax", "classes/IMaxClause", "classes/IMin", "classes/IMinClause", "classes/IResource", "classes/ISelect", "classes/ISelectClause", "classes/IService", "classes/IServiceEvents", "classes/ISum", "classes/ISumClause", "classes/ITotal", "classes/ITotalClause", "classes/LibraryDescriptor", "classes/Log", "classes/Message", "classes/NotificationDescriptor", "classes/NotificationException", "classes/NotificationManager", "classes/Registration", "classes/Resources", "classes/Select", "classes/Service", "classes/ServiceDescriptor", "classes/ServiceDescriptor.Request", "classes/ServiceDescriptor.Request.HeaderParameter", "classes/ServiceDescriptor.Request.QueryParameter", "classes/ServiceEventHandler", "classes/ServiceException", "classes/ServiceHandler", "classes/SIDatasHelper", "classes/SIJsonHelper", "classes/Siminov", "classes/SiminovException", "classes/SiminovExceptionHandler", "classes/StringBuilder", "classes/SyncDescriptor", "classes/SyncException", "classes/SyncHandler", "classes/SyncRequest", "classes/WebSiminovDatas", "classes/WebSiminovDatas.WebSiminovData", "modules/Adapter", "modules/Collection", "modules/Connection", "modules/Database", "modules/Design", "modules/Events", "modules/Exception", "modules/Impl", "modules/Log", "modules/Model", "modules/Notification", "modules/Parser", "modules/Resource", "modules/Service", "modules/Sync", "modules/Utils"]'>
        </form>
    </div>
</div>
<div class="container">
	            ...
	            <div class="tab-content" style="border: 1px solid #DDD; border-top:0;">
	                <div class="tab-pane active" id="classes">
	                    <ul id="api-classes" class="nav nav-list">
	                            ...
	                            <li><a href="../classes/DatabaseMappingDescriptor.Attribute.html">DatabaseMappingDescriptor.Attribute</a></li>
	                            ...
	                            <li><a href="../classes/SIJsonHelper.html">SIJsonHelper</a></li>
	                            ...
	                            <li><a href="../classes/WebSiminovDatas.html">WebSiminovDatas</a></li>
	                            <li><a href="../classes/WebSiminovDatas.WebSiminovData.html">WebSiminovDatas.WebSiminovData</a></li>
	                    </ul>
	                </div>
                ...
                <div id="docs-main">
                    <div class="content">
                        <div class="page-header">
                            <h1>docs.javascript\assets\vendor\bootstrap\js\bootstrap.min.js <small>File</small></h1>
                        </div>
